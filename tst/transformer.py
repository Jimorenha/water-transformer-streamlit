...
# Transformer详解:https://blog.csdn.net/Tink1995/article/details/105080033
class Transformer(nn.Module):
    ...
    def __init__(self,
        ...
        self.max_pooling = nn.AdaptiveMaxPool2d((n_steps_out, d_model))
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # Decoding stack
        decoding =encoding[:, :self.n_steps_out, :]
        K = decoding.shape[1]
